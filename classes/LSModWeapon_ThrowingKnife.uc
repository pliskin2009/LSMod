...
*/
class LSModWeapon_ThrowingKnife extends AOCThrowableWeapon;
...
DefaultProperties
{
	...
	WeaponProjectiles(0)=class'LSModProj_ThrownDagger'
	...
	ConfigProjectileBaseDamage[5]=(Damage=15,InitialSpeed=2500.0,MaxSpeed=3000.0,AmmoCount=8,InitialGravityScale=0.90,Drag=0.000005,PitchCorrection=200)
	iFeintStaminaCost=0
	WeaponFontSymbol="S"
	WeaponReach=100
	WeaponLargePortrait="SWF.weapon_select_throwknife"
	WeaponSmallPortrait="SWF.weapon_select_throwknife"
