...
*/
class LSModWeaponAttachment_Crossbow extends AOCWeaponAttachment;
...
DefaultProperties
{
	...
	WeaponClass=class'LSModWeapon_Crossbow'
	WeaponSocket=CrossBowPoint
	bHasAmmo=true

	WeaponStaticMesh=StaticMesh'WP_xbw_Crossbow.sm_crossbow'
